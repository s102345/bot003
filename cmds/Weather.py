    ...
    async def 天氣(self,ctx,msg):
        ...
        if(r.status_code == 200):
            ...
            if(parameter_list == []):
                ...
                embed=discord.Embed(title=msg, description='以下為開始時間，以6小時為單位\n第一列：'+startTime_list[0]+'\n第二列：'+startTime_list[1]+'\n第三列：'+startTime_list[2])
                ...
                embed.add_field(name='最低溫', value=parameter_list[6]+'度', inline=True)
                embed.add_field(name='最低溫', value=parameter_list[7]+'度', inline=True)
                embed.add_field(name='最低溫', value=parameter_list[8]+'度', inline=True)
                ...
                embed.add_field(name='最高溫', value=parameter_list[12]+'度', inline=True)
                embed.add_field(name='最高溫', value=parameter_list[13]+'度', inline=True)
                embed.add_field(name='最高溫', value=parameter_list[14]+'度', inline=True)
